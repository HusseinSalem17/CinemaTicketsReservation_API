...
urlpatterns = [
    ...
    # 5.1 GET PUT DELETE from rest framework class based view APIView (send parameter int (pk))
    path("rest/cbv/<int:pk>", views.CBV_pk.as_view()),
    # 5.2 GET PUT DELETE from rest framework class based view APIView (send parameter int (pk))
    path("rest/cbv/<int:pk>", views.CBV_pk.as_view()),
]
