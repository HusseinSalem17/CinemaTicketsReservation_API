...
INSTALLED_APPS = [
    "tickets", # to use the app
    "rest_framework", # to use rest framework
...
REST_FRAMEWORK = {
    ...
    #     "rest_framework.authentication.BasicAuthentication",
        "rest_framework.authentication.TokenAuthentication", # to get the token then make url to get the the token
    ],
